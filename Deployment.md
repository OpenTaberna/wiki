...
> **📘 See [Configuration Guide](/Configuration)** for comprehensive configuration documentation including Docker secrets, Kubernetes secrets, and all available settings.
...
```bash
cd /opt
git clone https://github.com/opentaberna/opentaberna.git
cd opentaberna
```
...
- **GitHub Issues:** https://github.com/opentaberna/opentaberna/issues
